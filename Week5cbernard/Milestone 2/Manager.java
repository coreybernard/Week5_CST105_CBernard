...
public class Manager {
	...
	public void createPlayers(){
		Player player1 = new Player("Julio Jones", "Wide Receiver", "Atlanta Falcons", 75, 220, 28, 11,
				7, "Alabama");
		Player player2 = new Player("Tom Brady", "Quarterback", "New England Patriots", 76, 225, 39, 12,
				18, "Michigan");
		Player player3 = new Player("Ezekial Elliot", "Running Back", "Dallas Cowboys", 72, 225, 21, 21,
				2, "Ohio State");
		Player player4 = new Player("Antonio Brown", "Wide Receiver", "Pittsburg Steelers", 70, 181, 28, 84,
				8, "Central Michigan");
		Player player5 = new Player("Antonio Gates", "Tight End", "Los Angeles Chargers", 76, 255, 37, 85,
				15, "Kent State");
		Player player6 = new Player("Eric Berry", "Safety", "Kansas City Cheifs", 72, 212, 28, 29,
				8, "Tennessee");
